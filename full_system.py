...
model_detect = tflite.Interpreter(model_path='model.tflite', experimental_delegates=[tflite.load_delegate('libedgetpu.so.1.0')])
model_detect.allocate_tensors()

model_classify = tflite.Interpreter(model_path='model.tflite', experimental_delegates=[tflite.load_delegate('libedgetpu.so.1.0')])
