...
def train_network(model, num_epochs, optimizer, loss_function, trainloader, validloader, device, patience=10, path_to_model='detection_network', scheduler=None):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        if early_stop.counter == 0:
            torch.save({
                ...
                }, 'full_model_detect.tar')
            torch.save(model, 'model_detect.pth')
